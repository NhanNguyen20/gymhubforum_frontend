...
const UserBanListTable = () => {
  ...
  return (
    <div className="overflow-x-auto shadow-md sm:rounded-lg bg-gray-100 p-4 mx-auto w-11/12">
      <table className="min-w-full bg-white border border-gray-300">
        <thead className="bg-gray-200">
          <tr>
            ...
            <th className="px10 py-3 border-b border-gray-300 text-left text-gray-700 w-32">Ban Duration</th>
          </tr>
        </thead>
        <tbody>
